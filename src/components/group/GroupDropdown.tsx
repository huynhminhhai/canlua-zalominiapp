            ...
            {open && (
                <div className="absolute right-0 mt-1 w-40 bg-gray-50 border rounded-lg shadow-md z-10">
                    <ul className="py-2 text-[15px] leading-[22px] font-medium text-gray-700">
                        <li className="px-4 py-[6px] flex items-center gap-[8px]" onClick={(e) => handleEdit(e)}>
                        ...
                        <li className="px-4 py-[6px] flex items-center gap-[8px] text-[#bd373a]" onClick={(e) => handleDelete(e)}>
